...
<p align="center">
  ...
  <p align="center">
    StealedDomainNameWatcher is a batch script that automatically watch if a domain name you own is stealed and send the result to a Telegram Bot
    <br/>
    <br/>
...
StealedDomainNameWatcher is a batch script that automatically watch if a domain name you own is stealed
